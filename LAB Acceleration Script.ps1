:<# Lab Acceleration Script for Windows Server 2019
   Date:     05/30/2021
   Author:   Christian
   Version:  v1.5
#>
...
Do {
        Do {
            ...
            SRE-CLUSTER
			------------------------------------------
			11 = SRE-CLUSTER - Rename and Set IP Addresses
			12 = SRE-CLUSTER - Rename Only
			13 = SRE-CLUSTER - Set IP Addresses Only
